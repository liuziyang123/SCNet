...
class MobileNetV2(nn.Module):
    def __init__(self, output_stride=8, BatchNorm=None, width_mult=1., pretrained=True):
        ...
        self.pretrain_path = '../pretrained/deeplab-mobilenet.pth.tar'
    ...
    def _load_pretrained_model(self):
        ...
        print("I am loading the pretrained mobilenetv2 model")
        pretrain_dict = torch.load(self.pretrain_path)['state_dict']
        model_dict = {}
